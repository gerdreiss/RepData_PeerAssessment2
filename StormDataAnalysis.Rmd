...
merge_evtypes <- function(evtype) {
        ...
        new_evtype = ifelse(grepl("HURRICANE|TYPHOON", UPR), "HURRICANE",
                ifelse(grepl(".*(THUNERSTORM|THUDERSTORM|THUNDERSTORMW|THUNDERSTORM|THUNDEERSTORM|TSTM).*", UPR) & 
                      !grepl("NON", UPR), "THUNDERSTORM WIND", 
                ifelse(grepl("(HEAVY|EXCESSIVE|UNSEASONAL).?RAIN", UPR) & 
                      !grepl("THUNDERSTORM|TSTM|NON", UPR), "HEAVY RAIN",
